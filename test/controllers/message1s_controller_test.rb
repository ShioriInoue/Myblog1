...
class Message1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create message1" do
    assert_difference('Message1.count') do
      post message1s_url, params: { message1: { message: @message1.message, title: @message1.title } }
    end
  ...
  test "should update message1" do
    patch message1_url(@message1), params: { message1: { message: @message1.message, title: @message1.title } }
